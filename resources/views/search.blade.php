...
@section('content')
    <div class="tab-pane decisions-tab container_section fade show">
        ...
        <div class="d-flex directions_applications flex-column align-items-center">
            <div class="report_news d-flex flex-column">
                <a class="report_pdf report_pdf_news" href="!#" class="mb-3">
                    <img src="{{ asset('img/icons/pdf.png') }}" alt="pdf">Պաշտպանը դիմել է ՍԴ պատժախուց տեղափոխված
                    կալանավորներին և դատապարտյալներին հեռախոսային խոսակցություններից, նամակագրությունից և այլ
                    հաղորդակցությունից զրկման հարցով
                </a>
