...
@section('content')
    <div class="soldier_rights position-relative">
        <ul class="nav nav-tabs contact_us container" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button id="big_nav_tab" class="nav-link custom_list_group_action" id="section3-tab" data-bs-toggle="tab"
            ...
            <div class="tab-pane container_section fade show active" id="section0" role="tabpanel"
                ...
                <div class="d-flex flex-column directions_applications">
                    ...
                    <p class="soldier_rights_text">
                        Մարդու իրավունքնեի պաշտպանի գործունեության առաջնահերթություններից է զինված ուժերում մարդու
                        իրավունքների պաշտպանությունը, ներառյալ՝ զինծառայողներին և նրանց ընտանիքների անդամներին: Պաշտպանի
                        աշխատակազմն ունի մասնագիտական անհրաժեշտ կարողություններ՝ հետևելու զինված ուժերում իրավասու
                        մարմինների ու պաշտոնատար անձանց կողմից մարդու իրավունքների ապահովմանը:
                    </p>

                    <p class="soldier_rights_text">
                        2016 թվականից Պաշտպանի աշխատակազմում ստեղծվեց Քրեադատավարական և զինծառայողների իրավունքների
                        պաշտպանության մասնագիտացված վարչություն։ Արդեն 2017 թվականին հիմնվեց Զինծառայողների և նրանց
                        ընտանիքների անդամների իրավունքների պաշտպանության բաժինը, որը մասնագիտացված ստորաբաժանում է Քրեական
                        արդարադատության ոլորտում և զինված ուժերում մարդու իրավունքների պաշտպանության դեպարտամենտի կազմում:
                    </p>
