...
@endsection
@section('title') Child Rights @endsection
          ...
          <div class="tab-main">
            <div class="torture-audio d-flex flex-column directions_applications torture_directions_applications">
              ...
              <p class="soldier_rights_text">
                ...
                <br>
                <br>
                Երեխաների իրավունքների պաշտպանության ոլորտում Պաշտպանի գործունեությանը, ինչպես նաև ոլորտին առնչվող այլ հարցերին առավել մանրամասն ծանոթանալու համար կարող եք այցելել նշված կայք հետևյալ հղմամբ՝ <a class="child_page_link" href="children.ombuds.am">children.ombuds.am</a>:  
              </p>
            </div>
          </div>
        </div>
