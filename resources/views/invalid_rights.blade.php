...
@endsection
@section('title') Invalid Rights @endsection
          ...
          <div class="tab-header">
            <div class="d-flex align-items-baseline contact_us_action">
              ...
              <div class="contact_us_action_title">
                  <p>Հաշմանդամություն ունեցող մարդկանց իրավունքների պաշտպանություն</p>
              </div>
            </div>
          </div>
          <div class="tab-main">
            <div class="torture-audio d-flex flex-column directions_applications torture_directions_applications">
              ...
              <img src="{{ asset('img/invalid.png') }}" alt="invalid">

              <p class="soldier_rights_text">
                Հաշմանդամություն ունեցող մարդկանց իրավունքների պաշտպանությունը Մարդու իրավունքների պաշտպանի գործունեության հիմնարար ուղղություններից է:
              </p>

              <p class="soldier_rights_text">
                Հաշմանդամություն ունեցող մարդկանց իրավունքների պաշտպանությունն ունի առաջնահերթություն, ինչը պայմանավորված է նրանց իրավունքների ինքնուրույն իրացման միջավայրային ու այլ խոչընդոտների վերացման, հասարակությունում կարծրատիպերի վերացման պայմանով: Պետք է բարձր գնահատել հաշմանդամություն ունեցող յուրաքանչյուր մարդու արժանապատվությունն ու ներուժը: Նրանց մոտ պետք է ձևավորել ինքնուրույն կյանք վարելու հմտություններ ու ստեղծել լիարժեք ապրելու պայմաններ:
              </p>
