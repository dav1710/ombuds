...
<body>
    ...
    <header>
        <div class="preferences d-flex">
            ...
            <button class="prefInvis" onclick="font_tahoma()">
                <img src="{{ asset('img/icons/font_style.png') }}" alt="font style">
            </button>
            <button class="prefInvis" onclick="font_arial_armenian()">
            ...
            <div class="header_one">
                <div class="hot_line_content">
                    ...
                    <div class="hot_line_new">
                        <a href="tel:116"><img src="{{ asset('img/icons/hot_line_call.png') }}"></a>
                        <a href="{{ route('contactUs') }}"><img src="{{ asset('img/icons/hot_line_message.png') }}"></a>
                    </div>
                    <div class="messanger">
            ...
            <div class="header_three">
                <div class="position-relative big_lang_block">
                    ...
                    <div id="droped-languages">
                        <a href="{{ app()->getLocale() == 'am' ? 'javascript:void(0)' : asset('locale/am') }}"
                            class="lang-item">
                        ...
                        <a href="{{ app()->getLocale() == 'en' ? 'javascript:void(0)' : asset('locale/en') }}"
                            class="lang-item">
        ...
        <nav>
            @if (Route::current()->getName() == 'home')
                <div class="a-header-sm">
                    ...
                    <ul>
                        <li><a class="{{ Request::is('cooperation') ? 'active_nav' : '' }}"
                                href="{{ route('cooperation') }}">ԴԻՄԵԼ ՊԱՇՏՊԱՆԻՆ</a></li>
                        <li><a class="{{ Request::is('media') ? 'active_nav' : '' }}" href="{{ route('media') }}"
                                class="active">ԱՇԽԱՏԱՆՔԻ ՈՒՂՂՈՒԹՅՈՒՆՆԵՐ</a></li>
                        <li><a class="{{ Request::is('about') ? 'active_nav' : '' }}"
                                href="{{ route('reports') }}">ՀԱՂՈՐԴՈՒՄՆԵՐ և ԶԵԿՈՒՅՑՆԵՐ</a></li>
                        <li><a class="{{ Request::is('cooperation') ? 'active_nav' : '' }}"
                                href="{{ route('courses') }}">ԿՐԹՈՒԹՅՈՒՆ և ԻՐԱԶԵԿՈՒՄ</a></li>
                    </ul>
                </div>
            @endif
            ...
            <div class="link-item vertical-center">
                <a class="nav_link {{ Request::is('contact_us') ? 'active_nav' : '' }}"
                    href="{{ route('contactUs') }}" data-type="contact">
                    {{ __('main.contact_us') }}
                </a>
            </div>
            <div class="link-item vertical-center">
                <a class="nav_link {{ Request::is('directions') ? 'active_nav' : '' }}"
                    href="{{ route('directions') }}" data-type="contact">
                    ԱՇԽԱՏԱՆՔԻ ՈւՂՂՈւԹՅՈւՆՆԵՐ
                </a>
            </div>
            <div class="link-item vertical-center">
                <a class="nav_link {{ Request::is('reports') ? 'active_nav' : '' }}" href="{{ route('reports') }}"
                    data-type="contact">
                    ՀԱՂՈՐԴՈւՄՆԵՐ և ԶԵԿՈւՅՑՆԵՐ
                </a>
            </div>
            <div class="link-item vertical-center">
                <a class="nav_link {{ Request::is('courses') ? 'active_nav' : '' }}" href="{{ route('courses') }}"
                    data-type="contact">
            ...
            @if (Route::current()->getName() != 'home')
                <div class="a-header">
                    ...
                    <label for="main-nav" class="burger menu"><span></span></label>
                    <ul>
                        <li class="hidden_link"><a class="{{ Request::is('cooperation') ? 'active_nav' : '' }}"
                                href="{{ route('cooperation') }}">ԴԻՄԵԼ ՊԱՇՏՊԱՆԻՆ</a></li>
                        <li class="hidden_link"><a class="{{ Request::is('media') ? 'active_nav' : '' }}" href="{{ route('media') }}"
                                class="active">ԱՇԽԱՏԱՆՔԻ ՈՒՂՂՈՒԹՅՈՒՆՆԵՐ</a></li>
                        <li class="hidden_link"><a class="{{ Request::is('about') ? 'active_nav' : '' }}"
                                href="{{ route('reports') }}">ՀԱՂՈՐԴՈՒՄՆԵՐ և ԶԵԿՈՒՅՑՆԵՐ</a></li>
                        <li class="hidden_link"><a class="{{ Request::is('cooperation') ? 'active_nav' : '' }}"
                                href="{{ route('courses') }}">ԿՐԹՈՒԹՅՈՒՆ և ԻՐԱԶԵԿՈՒՄ</a></li>

                        <li><a class="{{ Request::is('cooperation') ? 'active_nav' : '' }}"
                                href="{{ route('cooperation') }}">ՄԻՋԱԶԳԱՅԻՆ ՀԱՄԱԳՈՐԾԱԿՑՈւԹՅՈւՆ</a></li>
                        <li><a class="{{ Request::is('media') ? 'active_nav' : '' }}" href="{{ route('media') }}"
                                class="active">ՄԵԴԻԱ ԿԵՆՏՐՈՆ</a></li>
                        <li><a class="{{ Request::is('about') ? 'active_nav' : '' }}"
                                href="{{ route('about') }}">ՄԵՐ ՄԱՍԻՆ</a></li>
                    </ul>
                </div>
            @endif
        </nav>
