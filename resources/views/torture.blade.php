    ...
    <div class="torture">
        <ul class="nav nav-tabs container d-flex flex-row justify-content-evenly" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link custom_list_group_action" id="section2-tab" data-bs-toggle="tab"
                    ...
                    aria-selected="false">Մշտադիտարկման այցեր</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link custom_list_group_action" id="section3-tab" data-bs-toggle="tab"
                    ...
                    aria-selected="false">Համագործակցություն</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link custom_list_group_action torture-first active" id="section0-tab"
                    data-bs-toggle="tab" data-bs-target="#section0" type="button" role="tab" aria-controls="section3"
                    aria-selected="false">Սահմանադրական դատարան
                    դիմումներ և նախագծեր</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link custom_list_group_action" id="section4-tab" data-bs-toggle="tab"
                    data-bs-target="#section4" type="button" role="tab" aria-controls="section4"
                    aria-selected="false">Տարեկան և արտահերթ զեկույցներ, իրավական վերլուծություններ</button>
            </li>
        </ul>
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane container_section fade show active" id="section0" role="tabpanel"
                ...
                <div class="d-flex directions_applications flex-column directions_applications">
                    ...
                    <p class="torture_big_text" style="margin-top: 30px">
                        Խոշտանգումների դեմ ՄԱԿ-ի կոնվենցիայի կամընտիր արձանագրությամբ նախատեսվում է ստեղծել կանխարգելման
                        անկախ ազգային մեխանիզմ, որը պետք է օժտված լինի լայն լիազորություններով, ունենա ազատ մուտքի և
                        համապատասխան ուսումնասիրությունների անցկացման հնարավորություն բոլոր այն վայրերում, որտեղ մարդիկ
                        կարող են զրկված լինել ազատությունից:
                        Կամընտիր արձանագրության վավերացումից հետո ՀՀ մարդու իրավունքների պաշտպանը ճանաչվել է
                        կանխարգելման անկախ ազգային մեխանիզմ:
                        Կանխարգելման ազգային մեխանիզմի կարգավիճակով Պաշտպանի գործունեության նպատակն է խոշտանգումների և
                        այլ դաժան, անմարդկային կամ արժանապատվությունը նվաստացնող վերաբերմունքի կանխարգելումն
                        ազատությունից զրկման վայրերում («Մարդու իրավունքների պաշտպանի մասին» ՀՀ սահմանադրական օրենքի
                        27-րդ հոդված):
                ...
                <div class="directions_applications d-flex flex-column align-items-center">
                    <div class="report_news d-flex flex-column">
                        <a class="report_pdf report_pdf_news" href="!#" class="mb-3">
                            <img src="{{ asset('img/icons/pdf.png') }}" alt="pdf">Պաշտպանը դիմել է ՍԴ պատժախուց
                            տեղափոխված կալանավորներին և դատապարտյալներին հեռախոսային խոսակցություններից,
                            նամակագրությունից և այլ հաղորդակցությունից զրկման հարցով
                        </a>
            ...
            <div class="tab-pane container_section fade" id="section3" role="tabpanel" aria-labelledby="section3-tab">
                ...
                <div class="d-flex flex-column directions_applications align-items-center">
                    <a class="report_pdf" href="!#" class="mb-3">
                        <img src="{{ asset('img/icons/pdf.png') }}" alt="pdf">«2021 թվականին ՀՀ մարդու
                        իրավունքների պաշտպանի գործունեության, մարդու իրավունքների եւ ազատությունների պաշտպանության
                        վիճակի մասին» տարեկան հաղորդում (սեղմագիր)
                    </a>
                    <a class="report_pdf" href="!#">
                        <img src="{{ asset('img/icons/pdf.png') }}" alt="pdf">2021թ․ տարեկան հաղորդում ՀՀ մարդու
                        իրավունքների պաշտպանի գործունեության, մարդու իրավունքների և ազատությունների պաշտպանության վիճակի
                        մասին
                    </a>
                    <a class="report_pdf" href="!#">
                        <img src="{{ asset('img/icons/pdf.png') }}" alt="pdf">«2021 թվականին ՀՀ մարդու
